...
- In ``` <meta name="viewport" content="width=device-width, initial-scale=1 , minimum-scale=0.5 " /> ``` device-width means 100% of viewport width , 
  initial-scale means deafult zoom level when page is loaded initailly , minimum-scale means minimum zoom out possible( zoom out - use to view larger of element )  .
